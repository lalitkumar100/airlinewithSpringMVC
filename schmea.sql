...
select * from booking;
select * from wallet where user_id='USR571464';
select * from loyalty_Account where user_id='USR571464';


ALTER TABLE `user`
ADD COLUMN `role` VARCHAR(20) NOT NULL DEFAULT 'USER' AFTER `is_deleted`;
